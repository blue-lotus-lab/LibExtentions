...
/**
 * Crowd FundRaising, Based on time
 * 
 * disclaimer
 *
...
contract Crowdfunding is ReentrancyGuard {
    ...
    event CampaignCreated(uint256 indexed id, address indexed creator, uint256 goal, uint256 endTime);
    ...
    function createCampaign(uint256 _goal, uint256 _duration) external hasToken {
        ...
        emit CampaignCreated(campaignCounter, msg.sender, _goal, endTime);
    }

    function contribute(uint256 id, uint256 amount) external nonReentrant payable validCampaign(id) {
